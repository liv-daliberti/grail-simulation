...
same viewer attributes and survey responses. The constants are made
available under the repository's Apache 2.0 license; review LICENSE for the
complete grant of rights.
"""
