...
LOG_DIR=${LOG_DIR:-"$ROOT_DIR/logs/grail_wage"}
RUN_NAME=${RUN_NAME:-Qwen1.5B-GRAIL-WAGE}
TIMESTAMP=${TIMESTAMP:-$(date +%Y%m%d_%H%M%S)}

CONFIG=${CONFIG:-"$ROOT_DIR/recipes/Qwen2.5-1.5B-Instruct/grpo/config_grail_wage.yaml"}
