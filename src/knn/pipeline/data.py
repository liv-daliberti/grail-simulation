...
"""Study metadata helpers used by the Grail Simulation KNN pipeline.

Provides canonical participant-study specifications plus helper functions
for interpreting CLI tokens and mapping them onto pipeline studies.
"""
...
from ..core.opinion import DEFAULT_SPECS as _DEFAULT_OPINION_SPECS
