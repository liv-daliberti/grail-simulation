...
*Showing top 10 of 1121 configurations.*
...
*Showing top 10 of 1118 configurations.*
...
*Showing top 10 of 1036 configurations.*
...
*Showing top 5 of 1121 configurations.*
...
*Showing top 5 of 1118 configurations.*
...
*Showing top 5 of 1036 configurations.*
...
| Config | Accuracy ↑ | Baseline ↑ | Δ vs baseline ↑ | Best k | Eligible | MAE ↓ | Δ vs baseline ↓ | RMSE ↓ | R² ↑ |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| **tfidf_lr0p03_depth3_estim450_sub0p8_col0p8_l21_l11**<br>vectorizer=tfidf, lr=0.03, depth=3, estimators=450, subsample=0.8, colsample=0.8, λ=1, α=1 | 0.764 | 0.061 | +0.703 | — | 165 | 0.041 | +0.055 | 0.053 | 0.963 |
