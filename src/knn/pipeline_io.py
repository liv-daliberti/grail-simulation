...
"""Filesystem helpers for the Grail Simulation KNN pipeline.

Encapsulates loading of sweep and evaluation metrics so orchestration code
can rebuild report bundles without re-executing the pipeline stages.
"""
