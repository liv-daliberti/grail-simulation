...
"""Helpers for launching and configuring Open-R1 evaluation runs."""
...
def get_lighteval_tasks() -> list[str]:
    ...
    :returns: Sorted list of benchmark names recognised by this module.
    """
...
def run_lighteval_job(
    ...
    :param benchmark: LightEval benchmark identifier to execute.
    :param training_args: Training arguments containing Hub model metadata.
    :param model_args: Model configuration controlling evaluation behaviour.
    :returns: ``None``. Submits a SLURM job for the requested benchmark.
    """
...
def run_benchmark_jobs(
    ...
    :param training_args: Training arguments containing the benchmark list.
    :param model_args: Model configuration passed to benchmark submitters.
    :returns: ``None``. Dispatches benchmarks in sequence.
    """
