...
| tfidf_lr0p03_depth3_estim250_sub0p8_col0p6_l20p5_l10p1<br>vectorizer=tfidf, lr=0.03, depth=3, estimators=250, subsample=0.8, colsample=0.6, λ=0.5, α=0.1 | 0.642 | 0.074 | +0.568 | — | 162 | 0.086 | -0.049 | 0.115 | 0.839 |
| tfidf_lr0p03_depth3_estim250_sub1_col0p8_l21_l11<br>vectorizer=tfidf, lr=0.03, depth=3, estimators=250, subsample=1, colsample=0.8, λ=1, α=1 | 0.642 | 0.074 | +0.568 | — | 162 | 0.086 | -0.049 | 0.116 | 0.836 |
| tfidf_lr0p03_depth3_estim350_sub0p8_col0p6_l21_l10<br>vectorizer=tfidf, lr=0.03, depth=3, estimators=350, subsample=0.8, colsample=0.6, λ=1, α=0 | 0.636 | 0.074 | +0.562 | — | 162 | 0.086 | -0.049 | 0.116 | 0.837 |
| tfidf_lr0p03_depth3_estim250_sub1_col1_l20p5_l10p5<br>vectorizer=tfidf, lr=0.03, depth=3, estimators=250, subsample=1, colsample=1, λ=0.5, α=0.5 | 0.667 | 0.074 | +0.593 | — | 162 | 0.086 | -0.049 | 0.116 | 0.838 |
| tfidf_lr0p03_depth3_estim250_sub1_col1_l21p5_l10p5<br>vectorizer=tfidf, lr=0.03, depth=3, estimators=250, subsample=1, colsample=1, λ=1.5, α=0.5 | 0.660 | 0.074 | +0.586 | — | 162 | 0.086 | -0.049 | 0.116 | 0.837 |
| tfidf_lr0p03_depth3_estim350_sub0p8_col0p6_l20p5_l10<br>vectorizer=tfidf, lr=0.03, depth=3, estimators=350, subsample=0.8, colsample=0.6, λ=0.5, α=0 | 0.648 | 0.074 | +0.574 | — | 162 | 0.086 | -0.049 | 0.116 | 0.835 |
| tfidf_lr0p03_depth3_estim250_sub0p8_col0p6_l21p5_l10<br>vectorizer=tfidf, lr=0.03, depth=3, estimators=250, subsample=0.8, colsample=0.6, λ=1.5, α=0 | 0.642 | 0.074 | +0.568 | — | 162 | 0.086 | -0.049 | 0.116 | 0.837 |
| tfidf_lr0p03_depth3_estim350_sub0p8_col0p6_l21p5_l10<br>vectorizer=tfidf, lr=0.03, depth=3, estimators=350, subsample=0.8, colsample=0.6, λ=1.5, α=0 | 0.636 | 0.074 | +0.562 | — | 162 | 0.086 | -0.049 | 0.117 | 0.835 |
*Showing top 10 of 334 configurations.*
  Command: `python -m xgb.pipeline --stage full --tasks opinion --issues gun_control --studies study1 --tree-method hist --learning-rate-grid 0.03 --max-depth-grid 3 --n-estimators-grid 250 --subsample-grid 1 --colsample-grid 0.6 --reg-lambda-grid 1.5 --reg-alpha-grid 0.5 --text-vectorizer-grid tfidf --out-dir '<models_dir>' --dataset /n/fs/similarity/grail-simulation/data/cleaned_grail --max-features 200000`
...
| Config | Accuracy ↑ | Baseline ↑ | Δ vs baseline ↑ | Best k | Eligible | MAE ↓ | Δ vs baseline ↓ | RMSE ↓ | R² ↑ |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| **tfidf_lr0p03_depth3_estim350_sub0p7_col0p8_l21_l11**<br>vectorizer=tfidf, lr=0.03, depth=3, estimators=350, subsample=0.7, colsample=0.8, λ=1, α=1 | 0.752 | 0.061 | +0.691 | — | 165 | 0.042 | +0.055 | 0.053 | 0.963 |
...
| tfidf_lr0p03_depth3_estim350_sub0p7_col1_l21p5_l11<br>vectorizer=tfidf, lr=0.03, depth=3, estimators=350, subsample=0.7, colsample=1, λ=1.5, α=1 | 0.764 | 0.061 | +0.703 | — | 165 | 0.042 | +0.054 | 0.054 | 0.962 |
| tfidf_lr0p03_depth3_estim350_sub0p7_col1_l21_l11<br>vectorizer=tfidf, lr=0.03, depth=3, estimators=350, subsample=0.7, colsample=1, λ=1, α=1 | 0.758 | 0.061 | +0.697 | — | 165 | 0.042 | +0.054 | 0.054 | 0.962 |
| tfidf_lr0p03_depth3_estim350_sub0p7_col1_l20p5_l11<br>vectorizer=tfidf, lr=0.03, depth=3, estimators=350, subsample=0.7, colsample=1, λ=0.5, α=1 | 0.758 | 0.061 | +0.697 | — | 165 | 0.042 | +0.054 | 0.054 | 0.962 |
| tfidf_lr0p03_depth3_estim250_sub0p7_col0p8_l20p5_l11<br>vectorizer=tfidf, lr=0.03, depth=3, estimators=250, subsample=0.7, colsample=0.8, λ=0.5, α=1 | 0.764 | 0.061 | +0.703 | — | 165 | 0.042 | +0.054 | 0.053 | 0.963 |
| tfidf_lr0p03_depth3_estim250_sub0p7_col0p8_l21p5_l11<br>vectorizer=tfidf, lr=0.03, depth=3, estimators=250, subsample=0.7, colsample=0.8, λ=1.5, α=1 | 0.758 | 0.061 | +0.697 | — | 165 | 0.042 | +0.054 | 0.054 | 0.963 |
| tfidf_lr0p03_depth3_estim250_sub0p7_col0p8_l21_l11<br>vectorizer=tfidf, lr=0.03, depth=3, estimators=250, subsample=0.7, colsample=0.8, λ=1, α=1 | 0.758 | 0.061 | +0.697 | — | 165 | 0.042 | +0.054 | 0.054 | 0.963 |
| tfidf_lr0p03_depth3_estim350_sub0p7_col0p8_l21p5_l10p5<br>vectorizer=tfidf, lr=0.03, depth=3, estimators=350, subsample=0.7, colsample=0.8, λ=1.5, α=0.5 | 0.758 | 0.061 | +0.697 | — | 165 | 0.042 | +0.054 | 0.054 | 0.962 |
*Showing top 10 of 333 configurations.*
  Command: `python -m xgb.pipeline --stage full --tasks opinion --issues minimum_wage --studies study2 --tree-method hist --learning-rate-grid 0.03 --max-depth-grid 3 --n-estimators-grid 350 --subsample-grid 0.7 --colsample-grid 0.8 --reg-lambda-grid 1 --reg-alpha-grid 1 --text-vectorizer-grid tfidf --out-dir '<models_dir>' --dataset /n/fs/similarity/grail-simulation/data/cleaned_grail --max-features 200000`
...
- Lowest MAE: Study 2 – Minimum Wage (MTurk) (0.042); Highest MAE: Study 1 – Gun Control (MTurk) (0.086).
